...
export type ProductImageWithFile = ProductImage & { file?: File }
...
export async function parseProductFormData(req: Request): Promise<ProductFormData> {
...
export async function checkProductExists(productId: FormDataEntryValue | null, client: PoolClient) {
...
export async function updateImages(client: PoolClient, formData: ProductFormData): Promise<NextResponse | void> {
...
export async function updateSpecifications(client: PoolClient, formData: ProductFormData) {
...
export async function updateFaqs(client: PoolClient, formData: ProductFormData) {
...
export async function updateRelatedProducts(client: PoolClient, formData: ProductFormData) {
...
export async function updatePurchasedTogether(client: PoolClient, formData: ProductFormData) {
...
export async function syncProductChildren(client: PoolClient, formData: ProductFormData): Promise<NextResponse | void> {
  ...
  const imageError = await updateImages(client, formData);
  if (imageError) return imageError;

  await updateSpecifications(client, formData);
  await updateRelatedProducts(client, formData);
